  ...
  return (
    ...
    >
      <div className="w-full pl-4 md:pl-8 lg:pl-12">
        <div className="mb-20">
          <h1 className="text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[12rem] xl:text-[16rem] font-memesique font-black tracking-tighter leading-none text-left uppercase">
            247.ART
          </h1>
