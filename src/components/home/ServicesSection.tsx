...
const ServicesSection: React.FC = () => {
  return <AccordionItem value="services" className="border-none">
      <AccordionTrigger className="hover:no-underline px-0 py-0">
        <h2 className="text-[8rem] sm:text-[12rem] md:text-[16rem] lg:text-[24rem] xl:text-[32rem] font-agharti font-black tracking-normal leading-none uppercase w-full" style={{ WebkitTextStroke: '2px black' } as React.CSSProperties}>SERVICES</h2>
      </AccordionTrigger>
