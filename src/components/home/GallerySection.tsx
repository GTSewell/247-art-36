  ...
  return (
    <AccordionItem value="gallery" className="border-none">
      <AccordionTrigger className="hover:no-underline px-0 py-8">
        <h2 className="text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[12rem] xl:text-[16rem] font-aeroxys font-black tracking-tighter leading-none lowercase">gallery</h2>
      </AccordionTrigger>
