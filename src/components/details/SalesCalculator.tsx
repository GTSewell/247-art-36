...
const SalesCalculator = () => {
  const [calculationResults, setCalculationResults] = useState<CalculationResults>({
    packageCost: 1295,
    // Default to Signature Artist package cost
    stpRevenue: 0,
  ...
  return <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-3xl font-bold mb-6 text-gray-800 text-center">Calculate Your Potential</h2>
      ...
      <div className={`mt-4 p-3 rounded-md ${alertBgColor} flex items-start`}>
        ...
        <div>
          {calculationResults.breakEven ? <p>You've reached break-even point! Any additional sales will be profit.</p> : <p>
