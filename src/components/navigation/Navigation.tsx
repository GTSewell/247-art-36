...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-border/20 w-full">
      <div className="max-w-full mx-auto px-6 md:px-10 lg:px-16 xl:px-24">
