...
const WhatIsZap = () => {
  ...
  return <section id="what-is-zap" className="py-32 px-4 relative overflow-hidden">
      ...
      duration: 0.5
    }} className="container mx-auto relative" style={{
      zIndex: 2
    }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          delay: index * 0.1
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                }} className="w-full outline-none focus:ring-1 focus:ring-zap-yellow px-2 resize-none overflow-hidden my-0 bg-yellow-500 hover:bg-yellow-400 rounded-md mx-0 py-[6px]" />
                  </CardTitle>
                </CardHeader>
              </Card>
            </motion.div>)}
