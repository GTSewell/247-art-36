...
const JoinUndergroundSection = () => {
  ...
  const [benefits] = useState([
    ...
    <span key="commission">How does a <strong className="font-bold">0% or 25% COMMISSION</strong> sound? Traditional galleries charge anywhere from 30% - 60%, with an average of 50% commission. Well, we're not planning to be a "traditional" gallery at all, things need to be shaken up, and, we're here to do that with you. It's time for something different! Our aim is to put as much as possible back into artists pockets. Let's turn the "Starving artist" notion to the "Sufficiently fed and happy Artist" as a first step.</span>,
