...
const JoinUndergroundSection = () => {
  ...
  const [benefits] = useState([
    ...
    <span key="future"><strong className="font-bold">THE FUTURE IS HERE</strong> and we are already ahead of the game, and we don't want you to be left behind!<br /><br /><strong className="font-bold">Insert AI here</strong><br /><br />Wait. DON'T RUN! Aside from some artists having gripes with AI LLM's (Large Language Models) training off artworks all across the internets, this is not what we're about. The simple fact is, is that is no different from you sitting at your local museum and sketching the masters to refine your skills, or even just the everyday muses you pick up whilst doom-scrolling the social media.<br /><br />The simple fact is, you're the best LLM already, Human Intelligence, or, "HI".<br /><br />We're all about AI helping you make other things easier, more efficient. NOT your art. If you already use AI for your art practice, we're all supportive! Hey, we even used AI to help build this website, even to help with our nightmarish spreadsheets.<br /><br />Anyway, we are and will be at the forefront, finding out the BEST AI solutions to help artists with the day-to-day grind.</span>
  ]);
