...
const JoinUndergroundSection = () => {
  ...
  const [benefits] = useState([
    ...
    <span key="commission">How does a <strong className="font-bold">10% COMMISSION</strong> not 50% sound? Traditional galleries charge anywhere from 30% - 60%, with an average of 50% commission. Well, we're not planning to be a "traditional" gallery at all, things need to be shaken up, and, we're here to do that with you. It's time for something different! Our aim is to put as much as possible back into artists pockets. Let's turn the "Starving artist" notion to the "Sufficiently fed and happy Artist" as a first step.</span>,
    <span key="retail"><strong className="font-bold">Your very own retail print shop</strong> stocked with everything from your own custom stickers, T-shirts & Poster designs as affordable art for new age collectors, to premium line of signed/embossed Limited & Timed Edition Museum grade archival Fine Art Prints (Giclee). We'll take care of all the boring shit that's a hassle, consider us as you're print bitches for the 3 months. <strong className="font-bold">YOU just focus on your art!</strong></span>,
    <span key="profile">Not everyone can make it to our IRL space, and that's why we're taking it to the world with your very own <strong className="font-bold">247.art KICK-ASS digital profile!</strong> Each artist will receive their own custom profile, think of it as a 'Link in BIO' domain, just not as bland as what is out there today. We call it the artist <strong className="font-bold">ATLAS</strong>, an acronym for Artist BIO, Techniques/Styles, Links, Artworks & Social media. A searchable artist "encyclopedia" (do they even exist anymore?) all in one place!<br /><br />You can add/remove links to other sites, your socials and your available art collection.<br /><br /><div className="flex items-center gap-2 justify-center"><ArrowLeft className="w-5 h-5" /> <strong className="font-bold">[yournamehere].247.art</strong> <ArrowRight className="w-5 h-5" /></div></span>,
    <span key="future"><strong className="font-bold">THE FUTURE IS HERE</strong> and we are already ahead of the game, and we don't want you to be left behind!<br /><br /><div className="text-center"><strong className="font-bold">/// Insert AI here ///</strong></div><br /><br />Wait. DON'T RUN! Aside from some artists having gripes with AI LLM's (Large Language Models) training off artworks all across the internets, this is not what we're about. The simple fact is, it is no different from an artist sitting at a local museum and sketching the masters to refine your skills, or even just the everyday muses you pick up whilst doom-scrolling the social media. It just does it 1000x faster.<br /><br />The simple fact is, you are the best LLM already, Human Intelligence, or, "HI".<br /><br />We're all about AI helping you make the "other things in life" easier, more efficient. If you already use AI for your art practice, we're all supportive! Hey, we even used AI to help build this website, and even with our nightmarish spreadsheets.<br /><br />Anyway, we are and will be at the forefront, finding out the BEST AI solutions to help artists with the day-to-day grind.</span>
  ]);
