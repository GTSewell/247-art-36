...
const StoreCategorySection: React.FC<StoreCategorySectionProps> = ({
  ...
  return (
    <AccordionItem value={category.id} className="border-none">
      <AccordionTrigger 
        ref={onTriggerRef}
        className="hover:no-underline group px-2 md:px-0 py-2 flex-col items-start md:flex-row md:items-center md:justify-between w-full min-h-full cursor-pointer"
