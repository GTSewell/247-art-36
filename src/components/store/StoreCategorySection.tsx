...
const StoreCategorySection: React.FC<StoreCategorySectionProps> = ({
  ...
  return (
    <AccordionItem value={category.id} className="border-none">
      <AccordionTrigger 
        ref={onTriggerRef}
        className="hover:no-underline group px-2 md:px-0 flex-col items-start md:flex-row md:items-center md:justify-between w-full"
      >
        <div className="flex flex-col md:flex-row md:items-center w-full md:justify-between">
          <h2 
            className="store-category-title font-agharti font-black leading-none tracking-tighter bg-clip-text text-transparent transition-all duration-300 group-hover:scale-105 md:whitespace-nowrap w-full text-left md:w-auto"
            style={{
