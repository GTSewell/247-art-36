...
const ArtistDetailsPanel: React.FC<ArtistDetailsPanelProps> = ({ 
  ...
  return (
    <div className="flex flex-col justify-between h-full bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-md transition-shadow duration-300 hover:shadow-lg">
