  ...
  return (
    <main className="min-h-screen bg-[#9ec0d2]">
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        >
          <h1 className="text-4xl font-bold mb-6">Choose Your Launch Path</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          >
            <img 
              src="/lovable-uploads/f5ca4ccc-2476-4d46-b2e3-5a6de7057a38.png"
              alt="Launchpad"
          ...
          >
            <img 
              src="/lovable-uploads/44037d7b-42de-43f6-86ef-1eb4983e970b.png"
              alt="Rocket"
              className="w-full max-w-[300px] mx-auto"
            />
            <div className="bg-white/90 backdrop-blur rounded-lg p-6 shadow-lg">
