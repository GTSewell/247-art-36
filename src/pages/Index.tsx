...
const Index = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Why Use ZAP Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-zap-blue/30 to-transparent relative z-10">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-transparent to-zap-blue/30 relative z-10">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
