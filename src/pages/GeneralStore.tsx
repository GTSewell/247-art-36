        ...
        <div className="min-h-screen bg-background dark:bg-background text-foreground dark:text-foreground">
          ...
          <main className="container px-4 pt-24 pb-12 mx-0 py-[73px]">
            <div className="flex items-center justify-between mb-4">
              <Alert className="inline-block mb-0 bg-zap-yellow border-zap-yellow text-black text-center mx-[240px] py-0 px-0">
                <AlertDescription className="text-lg font-bold">This is a mock-up store page for demonstration purposes.</AlertDescription>
              </Alert>
